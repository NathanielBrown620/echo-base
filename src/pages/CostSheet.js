...
const s = {
 ...
 secHead: { padding: '10px 16px', fontWeight: '600', fontSize: '13px', backgroundColor: '#29ABE2', borderBottom: 'none', display: 'flex', justifyContent: 'space-between', alignItems: 'center', color: '#ffffff' },
  secTotal: { fontSize: '13px', color: '#ffffff', fontWeight: '600' },
